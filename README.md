...
pixi add cccl-python
# for installing globally
pixi global install cccl-python
```
...
It is possible to list all of the versions of `cccl-python` available on your platform:
...
```
pixi search cccl-python --channel conda-forge
```
